...
PAGES["swimming-in-the-bunker"] = {
    ...
    "blocks": [
        ...
        ("figure", {"src": "bunker/pool-slide", "sizes": [1200, 2000], "alt": "Water slide and pool inside the rock cavern of Itäkeskus Swimming Hall", "caption": "Inside the pool at Itäkeskus."}),
...
PAGES["lost-and-sound"] = {
    ...
    "blocks": [
        ...
        ("figgrid", {"cover": False, "items": [
            {"src": "las/concept-map-2025", "sizes": [1200], "alt": "Early concept map of the festival site with sticky notes and sketches", "caption": "Early concept map, 2025: collecting ideas for stages, social spaces and routes.", "framed": True},
            {"src": "las/site-plan-2025", "sizes": [1200], "alt": "Site plan 2025 drawn on an aerial photo of the farm", "caption": "Site plan 2025 on an aerial photo of the farm.", "framed": True, "max": 440},
        ]}),
        ("figgrid", {"cover": False, "items": [
            {"src": "las/explaining-plan", "sizes": [1200], "alt": "Lennart explaining the site plan drawn on a large concrete wall", "caption": "Explaining the site plan to the team on site.", "max": 440},
            {"src": "las/setup-aerial-2025", "sizes": [1200, 2000], "alt": "Aerial view of the asphalt area during setup with timber, pallets and tents", "caption": "The site during setup, 2025."},
        ]}),
...
PAGES["student-study"] = {
    ...
    "hero": {"src": "student-study/poster-langes-feld", "sizes": [1200, 2000], "alt": "Poster with the consolidated concept sketch for the Langes Feld district", "contain": False},
    "meta": [
    ...
    "blocks": [
        ...
        ("figure", {"src": "student-study/map-friedrichshafen", "sizes": [1200], "alt": "Plan of Friedrichshafen with the Langes Feld development area marked in red", "caption": "Plan of Friedrichshafen with the “Langes Feld” marked in red.", "framed": True}),
...
PAGES["helsinki-tallinn"] = {
    ...
    "blocks": [
        ...
        ("figgrid", {"cover": False, "items": [
            {"src": "research/viking-line-ferry", "sizes": [1200], "alt": "Viking Line ferry leaving Helsinki on a grey day", "caption": "The Viking Line ferry connecting Helsinki and Tallinn.", "max": 420},
            {"src": "research/gulf-of-finland-map", "sizes": [1200], "alt": "Map of the Gulf of Finland between Helsinki and Tallinn", "caption": "80 kilometres of sea between the two capitals.", "framed": True},
        ]}),
        ("h2", "Methods"),
